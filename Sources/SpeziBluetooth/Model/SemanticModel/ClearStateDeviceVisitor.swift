...
extension BluetoothDevice {
    func clearState(isolatedTo bluetooth: isolated Bluetooth) {
        bluetooth.bluetoothQueue.assertIsolated("ClearStateDeviceVisitor must be called within the Bluetooth SerialExecutor!")
